...
My main focus is **C# / .NET**, relational databases, API development and enterprise software. I have extensive experience with complex business processes, ERP systems, integrations and SQL-heavy applications.

I'm also **Co-Founder & Backend Engineer at GegLex**, where I work on backend architecture, APIs, database design, authentication, performance optimization, automated testing and deployment processes.
...
[![My Skills](https://skillicons.dev/icons?i=cs,dotnet,postgres,docker,git,github,githubactions,visualstudio,postman&theme=dark)](https://skillicons.dev)

`C#` · `.NET` · `ASP.NET Core` · `REST APIs` · `Microsoft SQL Server` · `PostgreSQL` · `Docker` · `GitHub Actions`

### Additional Experience

`VB.NET` · `Entity Framework Core` · `Dapper` · `Npgsql` · `SOAP Web Services` · `OpenAPI` · `JWT` · `xUnit` · `Sage 100` · `ERP Development` · `Windows Services`

---

## 🎯 Engineering Focus

- Backend architecture with **C# and .NET**
- REST APIs and system integrations
- Relational database design
- SQL performance analysis and optimization
- ERP and enterprise application development
- Data import and migration pipelines
- Authentication and authorization
- Automated unit and integration testing
- Containerized applications with Docker
- CI/CD pipelines with GitHub Actions
- Maintainable and production-oriented software architecture
